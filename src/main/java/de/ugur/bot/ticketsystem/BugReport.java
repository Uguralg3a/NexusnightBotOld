...
public class BugReport extends ListenerAdapter {
    ...
    public void onButtonInteraction(ButtonInteractionEvent event) {
        ...
        if (event.getButton().getId().equals("bugreport")) {
            ...
            if (!roles.contains("❌ × TicketBan")) {
                ...
                guild.createTextChannel("bug-report-von-" + event.getUser().getName(), guild.getCategoryById("1001577966435827862"))
                ...
                teamEmbed.setDescription("Typ: Bug Report");
