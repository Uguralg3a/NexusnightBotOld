    ...
    public void onButtonInteraction(ButtonInteractionEvent event) {
        ...
        if (event.getButton().getId().equals("openBewerbung")) {
            ...
            if (!roles.contains("❌ × TicketBan")) {
                ...
                guild.createTextChannel("bewerbung-von-" + event.getUser().getName(), guild.getCategoryById("1001577966435827862970703177240420373"))
            ...
            guild.createTextChannel("bewerbung-von-" + event.getUser().getName(), guild.getCategoryById("1001577966435827862"))
                    .addPermissionOverride(event.getMember(), EnumSet.of(Permission.VIEW_CHANNEL), null)
                    .addPermissionOverride(guild.getPublicRole(), null, EnumSet.of(Permission.VIEW_CHANNEL))
                    .addPermissionOverride(guild.getRoleById("1001577950682042448"), EnumSet.of(Permission.VIEW_CHANNEL), null)
                    .complete().sendMessageEmbeds(embed.build()).setActionRow(closedButton(), claimButton()).queue();
